...
INSERT INTO oauth_client_details VALUES('curl_client','product_api', '$2a$10$BurTWIy5NTF9GJJH4magz.9Bd4bBurWYG8tmXxeQh1vs7r/wnCFG2', 'read,write', 'client_credentials', 'http://localhost:8081', 'ROLE_PRODUCT_ADMIN', 7200, 0, NULL, 'true'); /*secret -> user*/
INSERT INTO oauth_client_details VALUES('curl_client2','product_api', '$2a$10$BurTWIy5NTF9GJJH4magz.9Bd4bBurWYG8tmXxeQh1vs7r/wnCFG2', 'read,write', 'authorization_code,password,implicit,refresh_token', 'http://localhost:8081', 'ROLE_PRODUCT_ADMIN', 7200, 0, NULL, 'true'); /*secret -> user*/